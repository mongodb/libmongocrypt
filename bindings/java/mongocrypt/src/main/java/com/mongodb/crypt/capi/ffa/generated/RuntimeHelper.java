...
final class RuntimeHelper {
    ...
    static {
        SYMBOL_LOOKUP = SymbolLookup.libraryLookup(
                Path.of("/opt/homebrew/Cellar/libmongocrypt/1.8.4/lib/","libmongocrypt.dylib"),
                Arena.global());
//        SymbolLookup loaderLookup = SymbolLookup.loaderLookup();
//        SYMBOL_LOOKUP = name -> {
//            return loaderLookup.find(name).or(() -> LINKER.defaultLookup().find(name));
//        };
    }
