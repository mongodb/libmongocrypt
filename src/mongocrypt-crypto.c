...
typedef enum {
   ...
   KEY_FORMAT_FLE2v2,   // 32 octets DATA key, 32 MAC key, 32 IV key (ignored)
...
typedef enum {
   ...
   MAC_FORMAT_FLE2v2,   // HMAC(AAD || IV || S)
...
// FLE2 used with FLE2IndexedEncryptedValue: AES-256-CBC HMAC/SHA-256
DECLARE_ALGORITHM (FLE2v2, CBC, SHA_256)
