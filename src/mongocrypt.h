...
void mongoc_crypt_init(void);

void mongoc_crypt_cleanup(void);

mongoc_crypt_opts_t *mongoc_crypt_opts_new(void);

void mongoc_crypt_opts_destroy(mongoc_crypt_opts_t *opts);

void mongoc_crypt_opts_set_opt(mongoc_crypt_opts_t *opts,
                               mongoc_crypt_opt_t opt, void *value);

mongoc_crypt_t *mongoc_crypt_new(mongoc_crypt_opts_t *opts,
                                 mongoc_crypt_error_t *error);

void mongoc_crypt_destroy(mongoc_crypt_t *crypt);

int mongoc_crypt_encrypt(mongoc_crypt_t *crypt,
                         const mongoc_crypt_bson_t *bson_schema,
                         const mongoc_crypt_bson_t *bson_doc,
                         mongoc_crypt_bson_t *bson_out,
                         mongoc_crypt_error_t *error);

int mongoc_crypt_decrypt(mongoc_crypt_t *crypt,
                         const mongoc_crypt_bson_t *bson_doc,
                         mongoc_crypt_bson_t *bson_out,
                         mongoc_crypt_error_t *error);
