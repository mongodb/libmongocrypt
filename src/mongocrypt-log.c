...
void _mongocrypt_default_log_fn (mongocrypt_log_level_t level, const char *message, void *ctx) {
    switch (level) {
...
void _mongocrypt_log_init (void) {
    /* initialize globals. */
...
void _mongocrypt_log_set_fn (mongocrypt_log_fn_t fn, void* ctx) {
...
void _mongocrypt_log (mongocrypt_log_level_t level, const char *format, ...) {
    va_list args;
    char *message;
