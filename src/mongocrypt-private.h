...
void _mongoc_crypt_set_error(mongoc_crypt_error_t *error, /* OUT */
                             uint32_t domain,             /* IN */
                             uint32_t code,               /* IN */
                             const char *format,          /* IN */
                             ...);

void _bson_to_mongocrypt_error(const bson_error_t *bson_error,
...
void mongoc_crypt_binary_from_iter(bson_iter_t *iter,
                                   mongoc_crypt_binary_t *out);
void mongoc_crypt_binary_from_iter_unowned(bson_iter_t *iter,
                                           mongoc_crypt_binary_t *out);
void mongoc_crypt_binary_cleanup(mongoc_crypt_binary_t *binary);
void mongoc_crypt_bson_append_binary(bson_t *bson, const char *key,
                                     uint32_t key_len,
...
bool _mongoc_crypt_marking_parse_unowned(const bson_t *bson,
                                         mongoc_crypt_marking_t *out,
                                         mongoc_crypt_error_t *error);
bool _mongoc_crypt_encrypted_parse_unowned(const bson_t *bson,
                                           mongoc_crypt_encrypted_t *out,
                                           mongoc_crypt_error_t *error);
bool _mongoc_crypt_key_parse(const bson_t *bson, mongoc_crypt_key_t *out,
                             mongoc_crypt_error_t *error);

void mongoc_crypt_key_cleanup(mongoc_crypt_key_t *key);

bool _mongoc_crypt_do_encryption(const uint8_t *iv, const uint8_t *key,
                                 const uint8_t *data, uint32_t data_len,
                                 uint8_t **out, uint32_t *out_len,
                                 mongoc_crypt_error_t *error);

bool _mongoc_crypt_do_decryption(const uint8_t *iv, const uint8_t *key,
                                 const uint8_t *data, uint32_t data_len,
                                 uint8_t **out, uint32_t *out_len,
                                 mongoc_crypt_error_t *error);

/* Modifies key */
bool _mongoc_crypt_kms_decrypt(mongoc_crypt_t *crypt, mongoc_crypt_key_t *key,
                               mongoc_crypt_error_t *error);
