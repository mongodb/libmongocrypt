...
#define TEST_UEV_HEX "06abcdefab123498761234123456789012024d069564f5a05e9e3523b98f575acb153b70d6d5f38dc752132c6928aaae8e5928e537a2ce407d847434d3d755635f9f80888371e7e1f9e42b9b70a485"
...
test_FLE2UnindexedEncryptedValue_parse (_mongocrypt_tester_t *tester)
{
   ...
   /* Test incorrect fle_blob_subtype */
   {
      ...
      _mongocrypt_buffer_copy_from_hex (
         &input, "05abcdefab123498761234123456789012024d069564f5a05e9e3523b98f575acb153b70d6d5f38dc752132c6928aaae8e5928e537a2ce407d847434d3d755635f9f80888371e7e1f9e42b9b70a485");
      uev = mc_FLE2UnindexedEncryptedValue_new ();
      ASSERT_FAILS_STATUS (
         mc_FLE2UnindexedEncryptedValue_parse (uev, &input, status),
         status,
...
test_FLE2UnindexedEncryptedValue_decrypt (_mongocrypt_tester_t *tester)
{
   ...
   /* Test an incorrect key. */
   {
      ...
      /* The middle 32 bytes of key are used to generate the mac. Change first byte to make S_Key
       * incorrect. */
